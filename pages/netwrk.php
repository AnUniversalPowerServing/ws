...
<head>
  <?php 
   if(isset($_GET["1"])){ 
     include_once 'templates/netwrk/'.$_GET["1"].'/00-netwrk-titles.php';
   } 
   ?>
  <meta charset="utf-8">
...
<?php 
  if(isset($_GET["1"])){ 
    include_once 'templates/netwrk/'.$_GET["1"].'/00-netwrk-menu.php';
  } 
?>
<script type="text/babel">
...
<?php if(isset($_GET["1"]) && isset($_GET["2"])){ ?>
  ...
  <div class="row">
   ...
   <?php 
     if(isset($_GET["1"])){ 
      include_once 'templates/netwrk/'.$_GET["1"].'/00-netwrk-content.php';
     } 
    ?>
   </div>
  </div>
